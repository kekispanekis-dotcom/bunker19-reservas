  ...
  return (
    <main className="min-h-screen bg-[#f4f4ef] text-[#102318]">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(4,13,8,.98), rgba(6,22,14,.86), rgba(6,22,14,.35)), url('https://images.unsplash.com/photo-1593111774240-d529f12cf4bb?q=80&w=1800&auto=format&fit=crop')",
