  ...
  return (
    <main className="min-h-screen bg-[#f4f4ef] text-[#102318]">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(90deg, rgba(0,0,0,.82), rgba(0,0,0,.55)), url('https://images.unsplash.com/photo-1587174486073-ae5e5cff23aa?q=80&w=1800&auto=format&fit=crop')",
        ...
        <div className="grid gap-5 md:grid-cols-4">
          {[
            [
              "⛳",
              "Simuladores profesionales",
              "Tecnología para una experiencia real.",
            ],
            [
              "🍸",
              "Drinks & comida premium",
              "Bebidas, platillos y buena vibra.",
            ],
            [
              "👥",
              "Ideal para grupos",
              "Cumpleaños, eventos y reuniones.",
            ],
            [
              "☆",
              "Ambiente premium",
              "Música, pantallas, deportes y golf.",
            ],
          ].map(([icon, title, text]) => (
            <div
              key={title}
